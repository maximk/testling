...
corrupter(Term) ->
    ?line try
	      S = io_lib:format("About to corrupt: ~P\n", [Term,12]),
	      io:put_chars(S)
	  catch
	      error:badarg ->
